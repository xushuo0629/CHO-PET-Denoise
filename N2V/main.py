...
parser.add_argument('--ny_in', type=int, default=336, dest='ny_in')
parser.add_argument('--nx_in', type=int, default=336, dest='nx_in')
parser.add_argument('--nch_in', type=int, default=3, dest='nch_in')

parser.add_argument('--ny_load', type=int, default=320, dest='ny_load')
parser.add_argument('--nx_load', type=int, default=320, dest='nx_load')
parser.add_argument('--nch_load', type=int, default=3, dest='nch_load')

parser.add_argument('--ny_out', type=int, default=320, dest='ny_out')
parser.add_argument('--nx_out', type=int, default=320, dest='nx_out')
